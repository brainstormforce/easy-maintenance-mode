...
class Admin_Settings {
    ...
    function gncd_register_setting() {
        ...
        register_setting(
            'maintenance_appearance_setting_group',
            'maintenance_mode_container_opacity'
        );
    ...
    public function gncd_register_setting_page() {
        ...
        <div class="wrap">
            ...
            <h2 class="nav-tab-wrapper">
                <a href="?page=gncountdown&tab=content_options" class="nav-tab <?php echo $active_tab == 'content_options' ? 'nav-tab-active' : ''; ?>">Content Options</a>
                <a href="?page=gncountdown&tab=appearance_options" class="nav-tab <?php echo $active_tab == 'appearance_options' ? 'nav-tab-active' : ''; ?>">Appearance Options</a>
            ...
            <?php do_settings_sections( 'maintenance_content_setting_group' ); ?>
                <table class="form-table">
                    ...
                    <th scope="row"> Enter Logo </th>
                        <td><input type="file" name="maintenance_mode_logo" id="show_logo" value="<?php echo esc_attr( get_option('countdown_logo') ) ?>">
                    </td>
